...
},{"../solutions.js":"solutions.js","./machine.js":"scripts/machine.js"}],"scripts/handleCloze.js":[function(require,module,exports) {
"use strict";
...
var checkAnswers = function checkAnswers(answers, solutions) {
  ...
  var optionElements = Array.from(_main.esercizio.querySelectorAll("option:checked"));
  var optionsChecked = optionElements.filter(function (option) {
    return option.value !== "";
  });
  optionsChecked === null || optionsChecked === void 0 ? void 0 : optionsChecked.forEach(function (option) {
    var currentSelect = option.parentNode;
    currentSelect.classList.remove("right");
    currentSelect.classList.remove("error");
    answers[currentSelect.name] === solutions[currentSelect.name] ? currentSelect.classList.add("right") : currentSelect.classList.add("error");
  });
};
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/handleCloze.js"], null)
//# sourceMappingURL=/handleCloze.9ada0fba.js.map