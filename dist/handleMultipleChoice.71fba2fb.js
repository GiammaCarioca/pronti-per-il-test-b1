...
},{"../solutions.js":"solutions.js","./machine.js":"scripts/machine.js"}],"scripts/handleMultipleChoice.js":[function(require,module,exports) {
"use strict";
...
var checkAnswers = function checkAnswers(answers, solutions) {
  ...
  var fields = Array.from(_main.esercizio.querySelectorAll("input[type='radio']"));
  var checkedFields = fields.filter(function (field) {
    return field.checked;
  });
  checkedFields === null || checkedFields === void 0 ? void 0 : checkedFields.forEach(function (field) {
    field.parentNode.parentNode.querySelectorAll("label").forEach(function (label) {
      label.classList.remove("right");
      label.classList.remove("error");
    });
    answers[field.name] === solutions[field.name] ? field.parentNode.classList.add("right") : field.parentNode.classList.add("error");
  });
};

_main.esercizio === null || _main.esercizio === void 0 ? void 0 : _main.esercizio.addEventListener("change", function (e) {
  e.target.checked && (answers[e.target.name] = e.target.value); // Send event
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/handleMultipleChoice.js"], null)
//# sourceMappingURL=/handleMultipleChoice.71fba2fb.js.map